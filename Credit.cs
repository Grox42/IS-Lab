...
public class Credit
{
    ...
    public void Print()
    {
        ...
        Console.WriteLine($"Procebt: {procent}");
        Console.WriteLine($"Term: {term}");
        if (schema == Schema.Annuity)
            Console.WriteLine($"Payment: {payment}");
        else {
            Console.WriteLine($"Payment first: {paymentMax}");
            Console.WriteLine($"Payment last: {paymentMin}");
        }
